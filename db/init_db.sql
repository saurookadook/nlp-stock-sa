SELECT 'CREATE DATABASE the_money_maker'
WHERE NOT EXISTS
        (
            SELECT
            FROM pg_database
            WHERE datname = 'the_money_maker'
        ) \gexec
...
ALTER DEFAULT PRIVILEGES
FOR ROLE migrations GRANT ALL
INSERT,
UPDATE,
DELETE, REFERENCES ON TABLES TO app;
